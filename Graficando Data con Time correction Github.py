...
"""
Formato:
06/09/18,8:53 AM, ,40.0029, ,$0.00,
06/09/18,5:40 PM, ,10.5976, ,$0.00,
06/09/18,9:21 PM, ,4.7050, ,$0.00,
"""

#JLM: Elimínale las Etiquetas ('Date', 'Time', 'Volume') del archivo de data
import pandas as pd
import numpy as np
...
df = Cuadro
fig, ax = plt.subplots()
ax.set(title='DATA UTILIZADA EN LA SEMANA')
...
plt.show()
#plt.savefig('Data Usage JLM.png')
#plt.savefig('Data Usage JLM1.png', transparent=True)
