...
print('Cuadro')
print(Cuadro)
#Cuadro = pd.DataFrame({'Day': index})
#Cuadro.loc['Day'] = pd.Series({'Day':index})
#df['A'] = 'foo'
#Cuadro['Day']= 'lunes', 'martes', 'miercoles', 'jueves', 'viernes', 'sabado', 'domingo'
Cuadro.loc['Lunes'] = pd.Series({'Day': 'Lunes', 'Madrugada':AverageLunesMadrugada, 'Mañana':AverageLunesMañana, 'Tarde':AverageLunesTarde,
          'Noche':AverageLunesNoche})
Cuadro.loc['Martes'] = pd.Series({'Day':'Martes', 'Madrugada':AverageMartesMadrugada, 'Mañana':AverageMartesMañana, 'Tarde':AverageMartesTarde,
          'Noche':AverageMartesNoche})
Cuadro.loc['Miércoles'] = pd.Series({'Day':'Miércoles', 'Madrugada':AverageMiércolesMadrugada, 'Mañana':AverageMiércolesMañana, 'Tarde':AverageMiércolesTarde,
          'Noche':AverageMiércolesNoche})
Cuadro.loc['Jueves'] = pd.Series({'Day':'Jueves', 'Madrugada':AverageJuevesMadrugada, 'Mañana':AverageJuevesMañana, 'Tarde':AverageJuevesTarde,
          'Noche':AverageJuevesNoche})
Cuadro.loc['Viernes'] = pd.Series({'Day':'Viernes', 'Madrugada':AverageViernesMadrugada, 'Mañana':AverageViernesMañana, 'Tarde':AverageViernesTarde,
          'Noche':AverageViernesNoche})
Cuadro.loc['Sábado'] = pd.Series({'Day':'Sábado', 'Madrugada':AverageSábadoMadrugada, 'Mañana':AverageSábadoMañana, 'Tarde':AverageSábadoTarde,
          'Noche':AverageSábadoNoche})
Cuadro.loc['Domingo'] = pd.Series({'Day':'Domingo', 'Madrugada':AverageDomingoMadrugada, 'Mañana':AverageDomingoMañana, 'Tarde':AverageDomingoTarde,
...
#plt.scatter(Cuadro['Madrugada'], Cuadro['Mañana'], Cuadro['Tarde'], Cuadro['Noche'],)
#plt.show()


#Cuadro.plot(kind="scatter", x=index, y=columns, alpha=0.4)
