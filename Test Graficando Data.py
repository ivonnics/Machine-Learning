...
#print(Cuadro)
Cuadro.loc['Lunes'] = pd.Series({'Madrugada':AverageLunesMadrugada, 'Mañana':AverageLunesMañana, 'Tarde':AverageLunesTarde,
          'Noche':AverageLunesNoche})
Cuadro.loc['Martes'] = pd.Series({'Madrugada':AverageMartesMadrugada, 'Mañana':AverageMartesMañana, 'Tarde':AverageMartesTarde,
          'Noche':AverageMartesNoche})
Cuadro.loc['Miércoles'] = pd.Series({'Madrugada':AverageMiércolesMadrugada, 'Mañana':AverageMiércolesMañana, 'Tarde':AverageMiércolesTarde,
          'Noche':AverageMiércolesNoche})
Cuadro.loc['Jueves'] = pd.Series({'Madrugada':AverageJuevesMadrugada, 'Mañana':AverageJuevesMañana, 'Tarde':AverageJuevesTarde,
          'Noche':AverageJuevesNoche})
Cuadro.loc['Viernes'] = pd.Series({'Madrugada':AverageViernesMadrugada, 'Mañana':AverageViernesMañana, 'Tarde':AverageViernesTarde,
          'Noche':AverageViernesNoche})
Cuadro.loc['Sábado'] = pd.Series({'Madrugada':AverageSábadoMadrugada, 'Mañana':AverageSábadoMañana, 'Tarde':AverageSábadoTarde,
          'Noche':AverageSábadoNoche})
Cuadro.loc['Domingo'] = pd.Series({'Madrugada':AverageDomingoMadrugada, 'Mañana':AverageDomingoMañana, 'Tarde':AverageDomingoTarde,
